  ...
  <div class="range-slider-group">
    ...
    <div class="flex items-center space-x-2">
      <input
        ...
        class="w-full h-2 bg-vybes-dark-element rounded-lg appearance-none cursor-pointer
      ...
      <input
        ...
        :value="modelValue"
        @input="$emit('update:modelValue', parseFloat($event.target.value))"
        class="w-20 p-1 text-sm bg-vybes-dark-element border border-vybes-dark-card rounded-md text-vybes-text-primary text-center focus:outline-none focus:ring-1 focus:ring-vybes-blue focus:border-vybes-blue"
      />
    </div>
  </div>
</template>
