<template>
    <div class="text-center py-10">
        <svg class="animate-spin h-8 w-8 text-vybes-brand mx-auto mb-3" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
        ...
        <p class="text-vybes-text-secondary">{{ message }}</p>
    </div>
</template>
